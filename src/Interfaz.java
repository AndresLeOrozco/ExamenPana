...
public class Interfaz {
    ...
    public void GuardarMedicamento(){
        ...
        nom = sc.next();
        System.out.println("Digite el tamanio en mg del medicamento ");
        tam = sc.next();
        System.out.println("Digite las instrucciones del medicamento ");
        ins = sc.next();

        while(bandera == false) {
            System.out.println("Digite el tipo de medicamento (P / C / J) ");
    ...
    public void EntregaMedicamento(){
        ...
        nom = sc.next();
        System.out.println("Digite la la fecha de retiro");
        Fech = sc.next();
